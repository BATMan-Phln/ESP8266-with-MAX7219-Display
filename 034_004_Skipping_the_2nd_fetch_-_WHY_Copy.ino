...
const char pass[] = "XXXXXXXXXXXX";       // your network password


// set location and API key
String Location = "XXXXXXXXXXXX, US";
...
const int timeZone = -8;     // XXXXXXXXXXXX Time
...
////  P.setFont(1, numeric7Seg);
  ...
  P.addChar('&', degF);
      ...
      fetch();      ///This is the only one that runs correctly.  WTF?
...
///// This is where I need to figure out how to display tempF once I resolve the fetch problem.   /////
...
///=======================================================
          ...
          //delay(1000);
     ///This displays CONNECTED but nothing more.
///=======================================================
