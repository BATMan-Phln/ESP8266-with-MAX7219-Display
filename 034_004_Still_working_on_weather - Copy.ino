...
const char ssid[] = "XXXXXXXXXXXXXXXXXXXX";  //  your network SSID (name)
const char pass[] = "XXXXXXXXXXXXXXXXXXXX";       // your network password


// set location and API key
String Location = "XXXXXXXXXXXXXXXXXXXX, US";
...
const int timeZone = -8;     // XXXXXXXXXXXXXXXXXXXX Time
